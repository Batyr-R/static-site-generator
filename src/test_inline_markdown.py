...
extract_markdown_links, extract_markdown_images, split_nodes_image, split_nodes_link, text_to_textnodes)
...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_text_to_textnodes2(self):
        result = text_to_textnodes("This is **text** with a word and a `code block` and an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg) and a [link](https://boot.dev)")
        self.assertListEqual([
            TextNode("This is ", TextType.TEXT),
            TextNode("text", TextType.BOLD),
    ...
    def test_text_to_textnodes3(self):
        result = text_to_textnodes("This is **text** with an _italic_ word and a **code block** and an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg) and a [link](https://boot.dev) and another **bold** word")
        self.assertListEqual([
            TextNode("This is ", TextType.TEXT),
            TextNode("text", TextType.BOLD),
            TextNode(" with an ", TextType.TEXT),
